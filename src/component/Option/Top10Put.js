...
const Top10Put = () => {
    ...
    const sortPutData = optionData.data.sort(function (a, b) {
        return b.PutPercentage - a.PutPercentage;
    })
    return (
        <div>
            <TableContainer component={Paper}>

               Top 10 Put purchased

                <Table className={classes.table} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            <StyledTableCell align="left">Symbol</StyledTableCell >
                            <StyledTableCell align="right">Put Vol</StyledTableCell >
                    ...
                    <TableBody>
                        {sortPutData.slice(0, 10).map((sortDataDetail) => (
                            <StyledTableRow key={sortDataDetail.Symbol}>
                                ...
                                <StyledTableCell align="right">{Math.floor(sortDataDetail.PutPercentage * 100)}</StyledTableCell >
